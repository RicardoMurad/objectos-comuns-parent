...
class BradescoOcorrenciaParser extends OcorrenciaParser {
  ...
  private static final Map<String, OcorrenciaCodigo> codigoMap = new Wrapper()
  ...
  private static class Wrapper extends BuilderWrapper {
    ...
    @Override
    OcorrenciaCodigo newInstance(int codigo, String descricao, MotivoParser motivoParser) {
